...
public class pertanyaan extends Activity implements OnClickListener 
{
	...
	ImageView soal;
	int []pertanyaan =
		{R.drawable.gelas,R.drawable.kursi,R.drawable.meja,R.drawable.sapu,R.drawable.papantulis};
	String [] jawaban =
		{"Cup","Chair","Table","Broom","White Board"};
	int indeks = 0;
	int salah = 0 , benar = 0 ,
	skor = 0;
	@Override
	...
	(v==btn_next)
	{
		...
		{
			Intent i=new Intent(pertanyaan.this,hasil.class);
