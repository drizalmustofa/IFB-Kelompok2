...
public class pertanyaan2 extends Activity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.pertanyaan2);
        ...
        jawab.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				// dialog
				AlertDialog.Builder dialog = new AlertDialog.Builder(pertanyaan2.this);
				...
				if (id == -1) {
					...
					if (id == R.id.opsi2) {
						// intent
						final Intent intent = new Intent(pertanyaan2.this, null);
